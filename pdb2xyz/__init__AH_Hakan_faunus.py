...
{%- endif %}
  ...
  - {charge: 0.0, hydrophobicity: !Lambda {{0.7538308115197386}}, mass: 57.05,  name: GLY, σ: 4.5,  ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.2672387936544146}}, mass: 101.11, name: THR, σ: 5.62, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.1897587086430935}}, mass: 71.09,  name: ALA, σ: 5.12, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.5170874160398543}}, mass: 131.2,  name: MET, σ: 6.18, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.950628687301107}},  mass: 163.18, name: TYR, σ: 6.46, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.2936174211771383}}, mass: 99.13,  name: VAL, σ: 5.86, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{1.033450123574512}},  mass: 186.22, name: TRP, σ: 6.78, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.5548615312993875}}, mass: 113.16, name: LEU, σ: 6.18, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.5130398874425708}}, mass: 113.16, name: ILE, σ: 6.18, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.3469777523519372}}, mass: 97.12,  name: PRO, σ: 5.56, ε: {{ "%.4f" % ec }}}
  - {charge: 0.0, hydrophobicity: !Lambda {{0.8906449355499866}}, mass: 147.18, name: PHE, σ: 6.36, ε: {{ "%.4f" % ec }}}
